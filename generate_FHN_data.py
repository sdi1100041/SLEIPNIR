from odin.utils.dynamical_systems import FitzHughNagumo
import numpy as np
...
parser.add_argument( "--final_time", type=float, default=10, help="final time of integration")
...
FHN = FitzHughNagumo(true_param=(0.2, 0.2, 3.0),
                     noise_variance=0.0,
                     stn_ratio=args.SNR)
...
for i in range(1,args.n_realizations+1):
    ...
    system_obs, t_obs = FHN.observe(initial_state=(-1.0, 1.0),
                                      initial_time=0.0,
                                      final_time=10.0,
